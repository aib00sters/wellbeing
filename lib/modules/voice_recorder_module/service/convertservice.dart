...
Future<ResultModel> getspeechdata({
  required String audiocontent,
}) async {
  // Map map = {"prompt": text1};
  const String apiKey = 'AIzaSyBBOCHroicaArCBbGlhsCGOTCkmZdhB9nA';
 
  const String url ='https://speech.googleapis.com/v1/speech:recognize?key=$apiKey';
  Map<String, dynamic> data = {
    'config': {
      'encoding': "MP3", // Or the appropriate encoding
      'sampleRateHertz': 44100, // Or the appropriate rate
