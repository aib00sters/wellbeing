...
abstract class $AnswerModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String imageUrl, String answerId, String answer, String questionId});
}
...
class _$AnswerModelImpl implements _AnswerModel {
  ...
  @override
  String toString() {
    return 'AnswerModel(imageUrl: $imageUrl, answerId: $answerId, answer: $answer, questionId: $questionId)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, imageUrl, answerId, answer, questionId);
...
abstract class _AnswerModel implements AnswerModel {
  const factory _AnswerModel(
      ...
      required final String questionId}) = _$AnswerModelImpl;
