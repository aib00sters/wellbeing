...
part 'avathar_generation_event.dart';
part 'avathar_generation_state.dart';
part 'avathar_generation_bloc.freezed.dart';

class AvatharGenerationBloc
    extends Bloc<AvatharGenerationEvent, AvatharGenerationState> {
  AvatharGenerationBloc() : super(const _Initial()) {
    on<AvatharGenerationEvent>((event, emit) async {
      emit(const AvatharGenerationState.initial());
      try {
        if (event is _getAvatar) {
          //this code should be replace when the actual avtar generation get implimented.
          //this code is act as a dummy purpose.
