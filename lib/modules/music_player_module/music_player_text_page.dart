...
import 'package:wellbeings/modules/music_player_module/views/common.dart';
...
class MusicPlayerTextPage extends StatefulWidget {
  final List<Activity> playlist;
  final String speech;
  const MusicPlayerTextPage(
      {super.key, required this.playlist, required this.speech});

  @override
  State<MusicPlayerTextPage> createState() => _MusicPlayerTextPageState();
}

class _MusicPlayerTextPageState extends State<MusicPlayerTextPage>
