...
public class AudioExtractor {
     ...
     * @param srcPath source video file path
     * @param dstPath destination audio file path
     * @param startMs start time in milliseconds (-1 for beginning)
     * @param endMs end time in milliseconds (-1 for no trimming)
     * @param useAudio true to extract audio
     * @param useVideo false for audio-only extraction
     */
    @SuppressLint("NewApi")
